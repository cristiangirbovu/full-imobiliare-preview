...
const SERVICII = [
  { id: 1, ordine: 1, evidentiat: true, slug: "consultanta-juridica-gratuita", titlu: "Consultanță juridică gratuită",
  ...
  { id: 2, ordine: 2, evidentiat: false, slug: "vanzari-imobiliare", titlu: "Vânzări imobiliare",
    ...
    continut: "Vânzarea unei proprietăți înseamnă un preț corect de la început, o prezentare care atrage cumpărătorii potriviți și o negociere care îți apără interesul. Ne ocupăm de tot lanțul, de la prima discuție până la predarea cheilor.\n\n## Cum lucrăm\nStabilim împreună prețul pe baza unei analize comparative de piață, pregătim fotografiile și anunțul, publicăm proprietatea pe site și pe portalurile partenere, organizăm vizionările și filtrăm ofertele. Îți prezentăm doar cumpărătorii serioși.\n\n## Exclusivitate sau nu\nȘapte din zece proprietăți listate la noi sunt în regim de exclusivitate, pentru că așa putem investi în promovare și putem răspunde pentru rezultat. Lucrăm însă și fără exclusivitate, în condiții discutate deschis de la început." },
  { id: 3, ordine: 3, evidentiat: false, slug: "inchirieri", titlu: "Închirieri",
    ...
    continut: "O închiriere bună începe cu chiriașul potrivit și cu un contract clar pentru ambele părți. Ne ocupăm de promovare, de selecție și de actele de predare, ca proprietarul să aibă venit constant și liniște.\n\n## Pentru proprietari\nEvaluăm chiria corectă pentru zonă, pregătim anunțul, organizăm vizionările și verificăm chiriașii înainte de semnare. Redactăm contractul, inclusiv clauzele de garanție și de întreținere, și predăm locuința pe bază de proces-verbal cu inventar și indexuri.\n\n## Pentru chiriași\nÎți propunem locuințe verificate, cu proprietari corecți și contracte fără surprize. Îți explicăm fiecare clauză înainte să semnezi." },
  ...
  { id: 6, ordine: 6, evidentiat: false, slug: "administrare-proprietati", titlu: "Administrare proprietăți",
    ...
    continut: "Dacă deții una sau mai multe locuințe închiriate, administrarea lor înseamnă timp: chiriași, încasări, întreținere, intervenții. Preluăm noi partea aceasta, iar tu primești raportul și venitul.\n\n## Ce include\nRelația cu chiriașii, urmărirea plăților și a cheltuielilor de întreținere, intervenții la defecțiuni cu meseriași verificați, predări și preluări la schimbarea chiriașului, raport lunar către proprietar." },
